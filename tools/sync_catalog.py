...
def main() -> int:
    ...
    if fresh != old:
        ...
        if args.write:
            ...
            # Расхождение разметки с витриной — само по себе дефект: именно
            # так поисковик и получил каталог из пятнадцати позиций против
            # двадцати двух. Хук должен об этом сказать, а не промолчать.
