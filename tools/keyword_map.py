...
Семантика несёт 585 запросов, и соблазн — сделать 585 страниц. Замер
13.08.2026 показывает, во что они сворачиваются на самом деле: по
(кластер, подкластер, интент) получается 132 группы, а внутри группы
запросы отличаются словами, а не намерением. «Генподрядчик не платит» и
«генподрядчик задерживает оплату» — одна страница, а не две.
