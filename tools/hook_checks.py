...
ROUTES: list[tuple[tuple[str, ...], str]] = [
    ...
    # Карта запросов: цель — либо опубликованная страница, либо объявленный
    # разрыв. Замер 16.08.2026: 227 строк метили в /baza-znanii/ и
    # /proverki/, которых на сайте нет, и колонка «Целевая страница»
    # выдавала план за факт. Правка страницы делает разрыв закрытым, правка
    # семантики — открытым, и обе расходятся с картой молча
    (("content/strategy/semantic-core.csv", "content/strategy/keyword-map.csv",
      "articles/", "products/", "materialy/"), "check_keyword_map.py"),
