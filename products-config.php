...
function mvb_products(): array
{
    return [
        ...
        'p8' => [
            'name'  => 'Комплект «Аванс по договору субподряда: условия, расчёт, протокол разногласий»',
            'price' => 249000,
        ...
        'p9' => [
            'name'  => 'Комплект «Генподрядчик банкротится: как заявить требование и не потерять долг»',
            'price' => 299000,
