...
function mvb_products(): array
{
    return [
        ...
        // статьёй узла и комплектом p10 за 14 900 ₽ не стояло ничего (замер
        // Funnel_Gap_2026-08-09.md, раздел 2, препятствие 1). Продаётся не
        ...
        't3' => [
            ...
            'price' => 99000,
            'dir'   => '15-odnostoronniy-akt-i-zachet',
            'zip'   => '15-odnostoronniy-akt-i-zachet.zip',
        ],
        ...
        'p10' => [
            'name'  => 'Комплект «Ответ на претензию заказчика или генподрядчика: документы против необоснованных штрафов и удержаний»',
            'price' => 1490000,
