...
def build_paid_07():
    ...
    create_word_doc(
        ...
        [
            ...
            {"text": ""},
            {"text": "2. ПРАВОВОЕ ОБОСНОВАНИЕ:"},
            {"text": "   Согласно ст. 333 ГК РФ, если подлежащая уплате неустойка явно несоразмерна последствиям нарушения обязательства, суд вправе её уменьшить. Если обязательство нарушено лицом, осуществляющим предпринимательскую деятельность, суд уменьшает неустойку при условии заявления должника (п. 1 ст. 333 ГК РФ)."},
            {"text": ""},
