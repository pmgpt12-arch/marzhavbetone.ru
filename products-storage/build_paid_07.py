...
def build_paid_07():
    ...
    create_word_doc(
        ...
        [
            ...
            {"text": "   Согласно ст. 309 ГК РФ обязательства должны исполняться надлежащим образом в соответствии с их условиями. Согласно ст. 310 ГК РФ односторонний отказ от исполнения обязательства не допускается."},
            ...
            {"text": ""},
            {"text": "4. ТРЕБОВАНИЕ:"},
            {"text": "   В срок, установленный пунктом [номер] Договора [если срок Договором не установлен — в срок, предусмотренный ст. 314 ГК РФ], перечислить сумму гарантийного удержания [сумма] руб. по реквизитам: [реквизиты]."},
            {"text": ""},
